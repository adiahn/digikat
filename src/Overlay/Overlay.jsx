...
const Overlay = () => {
    return(
        <div className="md:w-[90%] w-[90%] md:h-[250px] h-[full] pb-4 bg-indigo-100 rounded-[10px] m-auto relative top-[-8rem] flex md:flex-row flex-col over-scroll justify-center gap-4 " >
