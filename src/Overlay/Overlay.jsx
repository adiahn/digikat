...
const Overlay = () => {
    return(
        <div className="md:w-full w-full md:h-[250px] h-full bg-indigo-100 rounded-[10px] m-auto relative top-[-8rem] flex md:flex-row flex-col over-scroll justify-center gap-4" >
          ...
          <img className="w-full h-full absolute object-contain" src={map} />
