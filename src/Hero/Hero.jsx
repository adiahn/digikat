...
const header = () => {
    ...
    return (
        <m.header className="overflow-hidden relative mb-12 h-screen  px-16 pt-[10%] w-full" id="header">
            <div className="" id="gg">
            <div className="flex flex-col  justify-start w-[80%] h-full 2xl:h-auto ">      
          {/* h1 tag */}
         ...
         {/* short information about Website */}
                        <m.p
                        className="my-2 mb-6 opacity-0  py-4 lg:text-[3vw] xl:text-[36px] leading-tight font-poppins font-[500] text-[1rem] line-[2.7rem] text-white h-[8.625rem]  w-[full] text-start p-0"
                        animate={{ opacity: [0, 1] }}
